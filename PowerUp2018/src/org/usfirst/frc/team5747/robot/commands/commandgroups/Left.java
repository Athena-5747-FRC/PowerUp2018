...
public class Left extends CommandGroup {
    ...
    public Left() {
    	   ...
    	   if (Robot.gameData.charAt(0) == 'L' && Robot.gameData.charAt(1) == 'R')
    	   {
           ...
           if (Robot.gameData.charAt(0) == 'R' && Robot.gameData.charAt(1) == 'L')
          {
          	...
          	addSequential(new DriveArcade(Robot.drivetrain, FORWARD_SPEED ,0 ), 3.9);
           	addSequential(new MoveLimitedSubsystem(Robot.elevator, Elevator.ELEVATOR_SPEED), 5);
