...
public class SwitchPlusScaleRight extends CommandGroup {
    ...
    public SwitchPlusScaleRight() {
        if (Robot.gameData.length() > 0 && Robot.gameData.charAt(0) == 'R' && Robot.gameData.charAt(1) == 'L')
        {
        ...
        else if (Robot.gameData.length() > 0 && Robot.gameData.charAt(0) == 'L' && Robot.gameData.charAt(1) == 'R')
        {
        	addSequential(new DriveArcade(Robot.drivetrain, FORWARD_SPEED , 0), 3);
        	addSequential(new DriveArcade(Robot.drivetrain, FORWARD_SPEED , 0), 3);
        	addSequential(new DriveArcade(Robot.drivetrain, 0 , FORWARD_SPEED), 2);
